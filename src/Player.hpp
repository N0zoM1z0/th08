...
enum PlayerMainAnmScript
{
    PLAYER_MAIN_ANM_IDLE_UNFOCUSED = 0,
    PLAYER_MAIN_ANM_MOVE_LEFT_UNFOCUSED = 1,
    PLAYER_MAIN_ANM_STOP_LEFT_UNFOCUSED = 2,
    PLAYER_MAIN_ANM_MOVE_RIGHT_UNFOCUSED = 3,
    PLAYER_MAIN_ANM_STOP_RIGHT_UNFOCUSED = 4,
    PLAYER_MAIN_ANM_IDLE_FOCUSED = 5,
    PLAYER_MAIN_ANM_MOVE_LEFT_FOCUSED = 6,
    PLAYER_MAIN_ANM_STOP_LEFT_FOCUSED = 7,
    PLAYER_MAIN_ANM_MOVE_RIGHT_FOCUSED = 8,
    PLAYER_MAIN_ANM_STOP_RIGHT_FOCUSED = 9,
};
