...
| How do I reproduce the completed native Windows i386 gate? | Follow `docs/WINDOWS_I386_RUNTIME.md` in order. | Bootstraps VC7/DX8, cold-replays all accepted normal units, verifies normal and bugfix final links, builds bugfix last, and deploys an unpatched isolated runtime. A modern port or one successful link cannot substitute. |
